 ...
 */
public class DataCostEstimator {
	private static volatile DataCostEstimator instance = null;

	private DataCostEstimator() {

	}

	public static DataCostEstimator getInstance() {
		if (instance == null) {
			synchronized (DataCostEstimator.class) {
				if (instance == null) {
					instance = new DataCostEstimator();
				}
			}
		}
		return instance;
	...
	private static Map<String, ClassificationAlgorithm> CLASSIFICATION_ALGORITHMS = new HashMap<String, ClassificationAlgorithm>();
	static {
	...
	public double estimateMissclassificationCost(DawidSkene ds, String method, String object_id) {
