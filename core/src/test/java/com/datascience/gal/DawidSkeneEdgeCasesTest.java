...
public class DawidSkeneEdgeCasesTest {

	protected NominalProject getProject(Algorithm algorithm, List<String> categories){
	...
	protected NominalProject getBDSProject(List<String> categories){
